"""
Django settings for healthinsuranceusec_45591 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45591.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45591.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45591 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45591 App",
    "VERSION": "v1",
}
